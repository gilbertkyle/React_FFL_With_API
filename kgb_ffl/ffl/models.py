...
class PlayerWeek(models.Model):
    player = models.ForeignKey(
        Player, to_field="id", on_delete=models.CASCADE, related_name="week", null=False)
    year = models.IntegerField("Year")
    week = models.IntegerField("Week")
    points = models.FloatField("Points", default=0.0)

    # these fields not in use as of 9/1, but won't be deleted in case i use them later
